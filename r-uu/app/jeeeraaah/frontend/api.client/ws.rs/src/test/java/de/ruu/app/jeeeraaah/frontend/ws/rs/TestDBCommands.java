...
import de.ruu.app.jeeeraaah.frontend.ws.rs.dbcommand.DBClean;
import de.ruu.app.jeeeraaah.frontend.ws.rs.dbcommand.DBPopulate;
...
//@Disabled // Temporär deaktiviert wegen jboss-logging Konflikt
...
class TestDBCommands
{
    ...
    void debugJbossLoggingJar() {
        System.out.println("jboss-logging loaded from: " + org.jboss.logging.Logger.class.getProtectionDomain().getCodeSource().getLocation());
    }
}