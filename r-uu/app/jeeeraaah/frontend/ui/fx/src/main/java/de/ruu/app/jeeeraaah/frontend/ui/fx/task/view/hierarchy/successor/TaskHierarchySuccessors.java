...
//@ApplicationScoped
@Dependent public class TaskHierarchySuccessors extends TaskHierarchyAbstract
{
	/**
	 ...
	 * provide a {@link TaskHierarchySuccessors} instance.
	 */
	@Override public @NonNull TaskHierarchySuccessorsService service()
	{
		return (TaskHierarchySuccessorsService) super.service();
	}
}