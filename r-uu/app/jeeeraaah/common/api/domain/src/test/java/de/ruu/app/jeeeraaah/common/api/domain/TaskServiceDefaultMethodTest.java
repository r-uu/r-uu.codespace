...
class TaskServiceDefaultMethodTest
{
	static class DummyTaskService implements TaskService<TestTypes.SimpleTask>
	{
		...
		@Override public Optional<? extends TestTypes.SimpleTask> read(@NonNull Long id)
		{
			lastReadId.set(id);
			return toReturn;
		}
		...
		@Override public Set<? extends TestTypes.SimpleTask> findTasks(@NonNull Set<Long> ids) { return Set.of() ;}
	...
	@Test void defaultFindDelegatesToRead()
			throws Exception
	{
