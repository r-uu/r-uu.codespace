...
import de.ruu.app.jeeeraaah.common.api.domain.TaskGroupServiceFlat;
...
public abstract class TaskGroupServiceJPA
		implements TaskGroupService<TaskGroupJPA>, TaskGroupServiceLazy, TaskGroupServiceFlat
{
	protected abstract TaskGroupRepositoryJPA repository();
	private            TaskGroupRepositoryJPA repository = repository();
...
//	@PostConstruct private void postConstruct() { log.debug("repository available: {}", not(isNull(repository()))); }
	...
	@Override public @NonNull Set<TaskGroupFlat>      findAllFlat  (                ) { return repository.findAllFlat(); }
