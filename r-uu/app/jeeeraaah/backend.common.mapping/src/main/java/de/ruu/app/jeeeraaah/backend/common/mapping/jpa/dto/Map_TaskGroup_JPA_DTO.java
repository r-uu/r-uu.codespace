...
@Mapper public interface Map_TaskGroup_JPA_DTO
{
	...
	@NonNull TaskGroupDTO map(@NonNull TaskGroupJPA in, @NonNull @Context ReferenceCycleTracking context);
	...
	@ObjectFactory default @NonNull TaskGroupDTO create(@NonNull TaskGroupJPA in) { return new TaskGroupDTO(in); }
}